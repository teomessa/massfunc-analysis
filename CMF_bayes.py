...
else: 'No SCH fit requested! moving on...\n'
...
if userinput['PL_FLAG'].lower()=='yes':
 ...
 print '\t-> Results:'
 print '\t\talpha:    {}  +{} -{}\n'.format(round(alpha_mcmc[0][0],2),round(alpha_mcmc[0][1],2),round(alpha_mcmc[0][2],2))
else: 'No PL fit requested! moving on...\n'
